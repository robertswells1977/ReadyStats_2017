...
<head>
  ...
  <meta name="author" content="">
    ...
    <link href="css/8v8style.css" rel="stylesheet">
...
<div class="container-fluid">
	...
	<div class="row-fluid">
		<div id="gamefield" class="span8" style="position:relative; background-repeat: no-repeat; height:500px; width:675px; background-position:center; background-size:95%; ">
            <div class="player" id="box_a" style="position:relative; left:310px; top:110px;">GK</div>
            <div class="player" id="box_b" style="position:relative; left:310px; top:110px;">CB</div>
            <div class="player" id="box_c" style="position:relative; left:310px; top:110px;">LB</div>
            <div class="player" id="box_d" style="position:relative; left:310px; top:110px;">RB</div>
            <div class="player" id="box_e" style="position:relative; left:310px; top:110px;">CM</div>
            <div class="player" id="box_f" style="position:relative; left:310px; top:110px;">RM</div>
            <div class="player" id="box_g" style="position:relative; left:310px; top:110px;">LM</div>
            <div class="player" id="box_h" style="position:relative; left:310px; top:110px;">S</div>
            <div class="player" id="def_a" style="position:relative; left:384px; top:116px; background-color: #000; color:#fff;">X</div>
            <div class="player" id="def_b" style="position:relative; left:406px; top:148px; background-color: #000; color:#fff;">X</div>
            <div class="player" id="def_c" style="position:relative; left:379px; top:176px;  background-color: #000; color:#fff;">X</div>
            <div class="player" id="def_d" style="position:relative; left:384px; top:116px; background-color: #000; color:#fff;">X</div>
            <div class="player" id="def_e" style="position:relative; left:406px; top:148px; background-color: #000; color:#fff;">X</div>
            <div class="player" id="def_f" style="position:relative; left:379px; top:176px;  background-color: #000; color:#fff;">X</div>
            <div class="player" id="def_g" style="position:relative; left:384px; top:116px; background-color: #000; color:#fff;">X</div>
            <div class="player" id="def_h" style="position:relative; left:406px; top:148px; background-color: #000; color:#fff;">GK</div>
