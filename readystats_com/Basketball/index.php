...
<head>
  ...
  <meta name="author" content="">
    ...
    <link href="http://plays.readystats.com/css/bootstrap.min.css" rel="stylesheet">
    <link href="http://plays.readystats.com/css/bootstrap-responsive.min.css" rel="stylesheet">
    <link href="http://plays.readystats.com/css/style-4thgrade.css" rel="stylesheet">
  ...
  -->
    <script type="text/javascript" src="http://plays.readystats.com/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="http://plays.readystats.com/js/jquery.min.js"></script>
    <script src="//ajax.googleapis.com/ajax/libs/jqueryui/1.10.4/jquery-ui.min.js"></script>
    <script type="text/javascript" src="http://plays.readystats.com/js/scripts.js"></script>
    <script type="text/javascript" src="http://plays.readystats.com/js/movement-b.js"></script>
  <script type="text/javascript" src="http://plays.readystats.com/js/jquery.ui.touch-punch.min.js"></script>
...
function checkURL()
{
    ...
    if(qs !== null)
    {
      switch(qs)
      {
          case "offensivemotion":
              $("#offensivemotion").trigger("click");
              console.log("offensivemotion");
              break;
...
<div id="selectplay_dialog" style="text-align: center;">
    <button class="play_buttons" id="playone">Double Screen</button><br>&nbsp;<br>
    <button class="play_buttons" id="defense">Defense</button><br>&nbsp;<br>
    <button class="play_buttons" id="pressbreaker">Press Break</button><br>&nbsp;<br>
    <button class="play_buttons" id="box">Box - Out of Bounds</button><br>&nbsp;<br>
